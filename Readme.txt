...
byte AddByte()
	...
	Adds unsigned byte as a field, and returns the value.
...
sbyte AddSByte()
  ...
  Adds signed byte as a field, and returns the value.
...
ushort AddUShort()
  ...
  Adds unsigned short as a field, and returns the value.
...
short AddShort()  
  ...
  Adds signed short as a field, and returns the value.
...
uint AddUInt()
  ...
  Adds unsigned int as a field, and returns the value.
...
int AddInt()
  ...
  Adds signed int as a field, and returns the value.
...
float AddFloat(string name)
  ...
  Adds 4 byte float as a field, and returns the value.
...
double AddDouble()
  ...
  Adds 4 byte double as a field, and returns the value.
...
bool AddBool()
  ...
  Adds 1 byte bool as a field, and returns the value (false when byte is 0, true when byte is 1).
...
long AddLong()
  ...
  Adds signed long as a field, and returns the value.
...
string AddPaddedString(int length)
  ...
  Adds fixed length string as a field, and returns the value.
...
void AddComment(string name)
  ...
  Add a comment with given name to structure view, and returns nothing.

void AddComment(string name,int length)

  Add fixed length as a field with given name to structure view, and returns nothing.
	
void StartNodeWithVariable(string name,int length)

  Adds a sub node and fixed length as a field with given name as the new parent until required matching EndNode, and returns nothing.
